...
public class ManageUsersView {
    ...
    public class LoginMenuView extends Application {
        ...
        public void register(view.LoginMenuView loginMenuView) {
        ...
        public void registerSeller(view.LoginMenuView loginMenuView) {
        ...
        public void registerBuyer(view.LoginMenuView loginMenuView) {
            Stage stage = new Stage();
        ...
        public void loginPanel(view.LoginMenuView loginMenuView) {
            Stage stage = new Stage();
            VBox vBox = new VBox(10);
